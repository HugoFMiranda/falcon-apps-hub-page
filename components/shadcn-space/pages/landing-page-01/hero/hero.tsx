            ...
            >
                <div className="border-x border-border grid grid-cols-1 md:grid-cols-12">
                    <div className="md:col-span-7 px-4 sm:px-7 lg:px-10 py-8 lg:py-16 flex flex-col gap-12 justify-between border-b md:border-b-0 md:border-r border-border">
                        <div className="flex flex-col gap-4 sm:gap-8">
                            <div className="flex flex-col gap-2 sm:gap-3">
                                <motion.p variants={itemVariants} className="text-2xl font-medium text-foreground">I'm Rachel Johnson,</motion.p>
                                <motion.h1 variants={itemVariants} className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium">
                                    Experienced Product Designer{" "}
                                    <span className="inline-flex align-middle">
                                        <video
                                            className="w-24 lg:w-36 h-10 lg:h-14 object-cover rounded-full"
                                            autoPlay
                                            loop
                                            muted
                                            playsInline
                                        >
                                            <source
                                                src="https://images.shadcnspace.com/assets/video/hero-19-video.mp4"
                                                type="video/mp4"
                                            />
                                        </video>
                                    </span>
                            ...
                            <motion.div variants={itemVariants} className="flex flex-col gap-4">
                                <p className="text-lg text-muted-foreground">I design visually stunning and highly functional products that elevate brands and create seamless digital experiences.</p>
                    ...
                    <motion.div variants={imageVariants} className="md:col-span-5 w-full p-4 sm:p-6 lg:p-10">
                        <img src={"https://images.shadcnspace.com/assets/backgrounds/hero-19.webp"} width={410} height={529} className="w-full h-full object-cover" />
                    </motion.div>
                </div>
            </motion.div>
        </section>
